Public Class AwningControl
    ...
    Private Sub txtBx_Temp_MouseHover(sender As Object, e As System.EventArgs) Handles txtBx_Temp.MouseHover
        lblMsg.Text = "Brihtness at awning must activate"
        lblMsg.Visible = True
    End Sub
    ...
    Private Sub lbl_C_MouseHover(sender As Object, e As System.EventArgs) Handles lbl_Cd.MouseHover
        lblMsg.Text = "Brihtness at awning must activate"
        lblMsg.Visible = True
    End Sub

    Private Sub lbl_C_MouseLeave(sender As Object, e As System.EventArgs) Handles lbl_Cd.MouseLeave
        lblMsg.Text = ""
        lblMsg.Visible = False
    End Sub
    ...
    Private Sub Panel1_MouseHover(sender As Object, e As System.EventArgs) Handles Panel1.MouseHover
        lblMsg.Text = "Sets the awning ON of OFF"
        lblMsg.Visible = True
    End Sub
    ...
    Private Sub lbl_Temp_Click(sender As System.Object, e As System.EventArgs) Handles lbl_Temp.Click
